...
merged_data_wclass1 <- merged_data_wclass %>%
  select("FSA_postal_code", "count_dispensaries", "class", "COMMERCIAL PARKING LOT", "EATING ESTABLISHMENT", "ENTERTAINMENT ESTABLISHMENT/NIGHTCLUB", "HOLISTIC CENTRE", "MOBILE VENDING (FOOD TRUCK)", "MOBILE VENDING (ICE CREAM TRUCK)", "RETAIL STORE (FOOD)", "SMOKE SHOP", "VAPOUR PRODUCT RETAILER")
